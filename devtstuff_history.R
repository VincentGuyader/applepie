...
# The urls
my_desc$set("URL", "https://github.com/ThinkR-open/applepie")
my_desc$set("BugReports", "https://github.com/ThinkR-open/applepie")
# Save everyting
